...
var CoolKatakanaInput = function (_React$Component) {
  _inherits(CoolKatakanaInput, _React$Component);

  function CoolKatakanaInput(props) {
    _classCallCheck(this, CoolKatakanaInput);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CoolKatakanaInput).call(this));

    _this.state = { showValue: props.value };
    return _this;
  }

  _createClass(CoolKatakanaInput, [{
    ...
    value: function handleChange(e) {
      ...
      var value = inputValue.replace(/[ぁ-ゖ]/g, function (chr) {
    ...
    value: function render() {
      return _react2.default.createElement('input', { type: 'text', value: this.state.showValue,
        onChange: this.handleChange.bind(this),
        onBlur: this.handleBlur.bind(this) });
    }
  }]);

  return CoolKatakanaInput;
}(_react2.default.Component);

exports.default = CoolKatakanaInput;
...
var CcoolZenkakuInput = function (_React$Component) {
  _inherits(CcoolZenkakuInput, _React$Component);

  function CcoolZenkakuInput() {
    _classCallCheck(this, CcoolZenkakuInput);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(CcoolZenkakuInput).apply(this, arguments));
  }

  _createClass(CcoolZenkakuInput, [{
    ...
    key: 'handleChange',
    value: function handleChange(e) {
      var value = e.target.value.replace(/[!-~]/g, function (chr) {
    ...
    key: 'render',
    value: function render() {
      return _react2.default.createElement('input', { type: 'text', value: this.props.value,
        onChange: this.handleChange.bind(this) });
    }
  }]);

  return CcoolZenkakuInput;
}(_react2.default.Component);

exports.default = CcoolZenkakuInput;
...
var NormalInput = function (_React$Component) {
  _inherits(NormalInput, _React$Component);

  function NormalInput() {
    _classCallCheck(this, NormalInput);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(NormalInput).apply(this, arguments));
  }
...
var _normal_input = require('./normal_input');

var _normal_input2 = _interopRequireDefault(_normal_input);

var _uncool_zenkaku_input = require('./uncool_zenkaku_input');

var _uncool_zenkaku_input2 = _interopRequireDefault(_uncool_zenkaku_input);

var _cool_zenkaku_input = require('./cool_zenkaku_input');

var _cool_zenkaku_input2 = _interopRequireDefault(_cool_zenkaku_input);

var _uncool_katakana_input = require('./uncool_katakana_input');

var _uncool_katakana_input2 = _interopRequireDefault(_uncool_katakana_input);

var _cool_katakana_input = require('./cool_katakana_input');

var _cool_katakana_input2 = _interopRequireDefault(_cool_katakana_input);
...
var Root = function (_React$Component) {
  ...
  _createClass(Root, [{
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'h1',
            null,
            'onChange でハンドリングするComponent'
          ),
          _react2.default.createElement(_normal_input2.default, { value: this.state.normalInputValue,
            onChange: this.handleInputChange.bind(this, 'normalInputValue') }),
          _react2.default.createElement(
            'p',
            null,
            this.state.normalInputValue
          )
        ),
        _react2.default.createElement(
          'section',
          ...
          _react2.default.createElement(
            'h1',
            null,
            'あまりよくない感じの全角英数入力Component'
          ),
          _react2.default.createElement(_uncool_zenkaku_input2.default, { value: this.state.uncoolZenkakuInputValue,
            onChange: this.handleInputChange.bind(this, 'uncoolZenkakuInputValue') }),
          _react2.default.createElement(
            'p',
            null,
            this.state.uncoolZenkakuInputValue
          )
        ),
        _react2.default.createElement(
          'section',
          ...
          _react2.default.createElement(
            'h1',
            null,
            'わりといい感じの全角英数入力Component'
          ),
          _react2.default.createElement(_cool_zenkaku_input2.default, { value: this.state.coolZenkakuInputValue,
            onChange: this.handleInputChange.bind(this, 'coolZenkakuInputValue') }),
          _react2.default.createElement(
            'p',
            null,
            this.state.coolZenkakuInputValue
          )
        ),
        _react2.default.createElement(
          'section',
          ...
          _react2.default.createElement(
            'h1',
            null,
            'あまりよくない感じのカタカナ入力Component'
          ),
          _react2.default.createElement(_uncool_katakana_input2.default, { value: this.state.uncoolKatakanaInputValue,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'h1',
            null,
            'いい感じのカタカナ入力Component'
          ),
          _react2.default.createElement(_cool_katakana_input2.default, { value: this.state.coolKatakanaInputValue,
    ...
    value: function handleInputChange(propName, _e, value) {
      var newState = {};
...
},{"./cool_katakana_input":159,"./cool_zenkaku_input":160,"./normal_input":161,"./uncool_katakana_input":163,"./uncool_zenkaku_input":164,"react":158}],163:[function(require,module,exports){
'use strict';
...
var UncoolKatakanaInput = function (_React$Component) {
  _inherits(UncoolKatakanaInput, _React$Component);

  function UncoolKatakanaInput() {
    _classCallCheck(this, UncoolKatakanaInput);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(UncoolKatakanaInput).apply(this, arguments));
  }

  _createClass(UncoolKatakanaInput, [{
    key: 'componentWillUpdate',
    value: function componentWillUpdate() {
      var element = _reactDom2.default.findDOMNode(this);
      this.selectionStart = element.selectionStart;
    ...
    key: 'handleChange',
    value: function handleChange(e) {
      var value = e.target.value.replace(/[ぁ-ゖ]/g, function (chr) {
        return String.fromCharCode(chr.charCodeAt(0) + 0x60);
      });
      this.props.onChange(e, value);
    }
  ...
  return UncoolKatakanaInput;
}(_react2.default.Component);

exports.default = UncoolKatakanaInput;
...
var UncoolZenkakuInput = function (_React$Component) {
  _inherits(UncoolZenkakuInput, _React$Component);

  function UncoolZenkakuInput() {
    _classCallCheck(this, UncoolZenkakuInput);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(UncoolZenkakuInput).apply(this, arguments));
  }

  _createClass(UncoolZenkakuInput, [{
    key: "handleChange",
    value: function handleChange(e) {
      var value = e.target.value.replace(/[!-~]/g, function (chr) {
        return String.fromCharCode(chr.charCodeAt(0) + 0xFEE0);
  ...
  return UncoolZenkakuInput;
}(_react2.default.Component);

exports.default = UncoolZenkakuInput;
...
},{"./components/root":162,"react":158,"react-dom":2}]},{},[165]);
